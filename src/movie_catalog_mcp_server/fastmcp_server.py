...
def create_fastmcp_server() -> FastMCP:
    ...
    mcp = FastMCP.from_openapi(
        ...
        mcp_names={
            "list_theaters_theaters_get": "get_theaters",
            "create_theater_theaters_post": "create_theater",
            ...
            "create_movie_movies_post": "create_movie",
            "list_movies_movies_get": "get_movies",
